...
import PaasDashboard from "../components/PaasDashboard";
import IaasDashboard from "../components/IaasDashboard";
            ...
            >
              ...
              <div className="flex-1 w-full relative group">
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-[4/3] sm:aspect-[16/10] shadow-2xl shadow-slate-200/50 border border-slate-200/60 bg-white">
                  {catIdx === 0 ? (
                    /* SaaS gets the premium animated dashboard */
                    <SaasDashboard />
                  ) : catIdx === 1 ? (
                    /* PaaS gets the platform orchestration animation */
                    <PaasDashboard />
                  ) : (
                    /* IaaS gets the infrastructure dashboard */
                    <IaasDashboard />
                  )}
                </div>
              </div>
